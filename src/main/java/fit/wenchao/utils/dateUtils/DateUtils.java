package fit.wenchao.utils.dateUtils;
...
import static fit.wenchao.utils.dateUtils.DateUtils.DateFormatEnum.DATE_ONLY;
import static fit.wenchao.utils.dateUtils.DateUtils.DateFormatEnum.DATE_TIME;
...
public class DateUtils {
    ...
    public static String formatDate(Date date) {
        return formatDateWith(DATE_TIME.toString(), date);
    }
    ...
    public static Date parseDateWith(String dateStr) throws ParseException {
        return parseDateWith(DATE_TIME.toString(), dateStr);
    }
    ...
    public static void main(String[] args) throws ParseException {
        String s = formatDateWith(DATE_ONLY.toString(), new Date());
